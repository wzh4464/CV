...
\begin{cvsection}{Projects}
    ...
    {}
    {
        \cvbullet{Extended DiMergeCo from matrices to tensors, first in parallel co-clustering framework for 4D data.}
...
\begin{cvsection}{Skills}
    \skillgroup{Programming \& Systems}{
        Python (Advanced), C++ (Advanced), Rust, CUDA, MPI, OpenMP, Docker, Linux
    }
    \skillgroup{AI \& Machine Learning}{
        Deep Learning, Transformers, LLM Fine-tuning, Prompt Engineering, RAG, Computer Vision, Machine Unlearning, Representation Learning
    }
    \skillgroup{Frameworks \& Tools}{
        PyTorch (Advanced), OpenCV, Git, Ray, HuggingFace Transformers, TensorBoard
    }
\end{cvsection}
