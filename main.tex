...
\begin{cvsection}{Summary}
    Ph.D. with dual B.Sc. in Physics and Mathematics, specializing in machine learning on feature selection and data valuation. Expert in reinforcement learning for trading systems, statistical modeling, and high-performance computing. Published in top-tier venues (CIKM, AISTATS) with focus on data valuation and unsupervised machine learning. Passionate about developing innovative AI techniques for real-world applications.
\end{cvsection}
