...
\begin{cvsection}{Skills}
    ...
    \skillgroup{AI \& ML}{Deep Learning, Transformer, Model Optimization, LLM Fine-tuning}
    \skillgroup{Systems}{Distributed Systems, Real-Time Processing, HPC, MPI, OpenMP}
    \skillgroup{Frameworks}{PyTorch, OpenCV}
\end{cvsection}

\begin{cvsection}{Awards}
    \award{Hong Kong PhD Fellowship}{Top 5\% acceptance rate}{2020--2024}
    \award{National Scholarship (China)}{Top 2\% nationwide}{2017--2018}
