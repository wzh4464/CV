...
\begin{cvsection}{Selected Publications}
    \cvbullet{LiveVal: Time-Aware Data Valuation for Real-Time ML Systems, CIKM 2025 (Acceptance rate: 23\%)}
    \cvbullet{LMEraser: Large Model Unlearning via Adaptive Prompt Tuning, AISTATS 2025}
    \cvbullet{High-Performance Transaction Processing for Financial Systems, IEEE Transactions on Parallel and Distributed Systems (TPDS) 2024}
    \cvbullet{Scalable Co-Clustering for Large-Scale Data through Dynamic Partitioning and Hierarchical Merging, IEEE SMC 2024}
    \cvbullet{Ellipse Detection via Global Arc Compatibilities and Adaptive Co-Clustering for Real-World Measurement Systems, IEEE TIM 2025}
    \cvbullet{A convex-hull based method with manifold projections for detecting cell protrusions, Computers in Biology and Medicine 2024}
\end{cvsection}
