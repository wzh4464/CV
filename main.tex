...
\begin{cvsection}{Experience}
    \cvblock{Jan 2026 -- Present}
    {Hong Kong}
    {Huawei Tech. Investment Co. Ltd}
    {Senior Research Engineer}
    {Develop AI-assisted software engineering systems, with a focus on AI code review and coding agents.}
    {}
    {}
    {}
...
\begin{cvsection}{Projects}
    ...
    {Context Graph: Long-term Memory for Coding Agents}
    {Python, Neo4j, LLM, RAG, HippoRAG, SWE-agent}
    {}
    {
        \cvbullet{Built a long-term memory system that distills 1,795 past SWE-agent trajectories into a context graph (45K nodes, 74K edges) of reusable debugging strategies and error patterns}
        \cvbullet{Designed a HippoRAG-style retrieval pipeline fusing cosine, BM25, and Personalized PageRank channels via RRF merge and MMR reranking for multi-hop strategy recall}
        \cvbullet{Improved SWE-bench-Verified resolve rate to 66.6\% over a 58.0\% no-memory baseline (+8.6 pp), outperforming ExpeL, FAISS, and AgentKB baselines}
    }
    {}
    \project{2023 -- 2025}
